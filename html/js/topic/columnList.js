define(['require', "app", 'jquery', '../data/getData', './classForm', '../common/editPop', 'formlist', 'fixedNav', 'position', '../moduls/service', '../moduls/factory'], function(require, app, $, getData, list, editPop) {
                ...
                angular.extend($scope, {
                    edit: function(obj) { //保存 obj为原始数据
                        function updateData(callback) { //填充数据
                            GenerateArrList.changeTypeName([obj], [{
                                name: 'columnName',
                                newName: 'name'
                            }])
                            callback({
