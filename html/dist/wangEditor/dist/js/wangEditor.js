...
e.$body.append(o),c.ready(function(){var e=o.outerWidth()+5;d.outerWidth(),parseFloat(d.css("margin-left"),10);
// 计算完，拿到数据，则弃用
o.remove(),o=null,
// 重新设置样式
d.css({width:e,
...
// enter时，不能使用 div 换行
n.fn.bindEnterForDiv=function(){function n(){if(i){
//替换DIV
var e=t('<p style="text-indent:2em;">'+i.html()+"</p>");i.after(e),i.remove()}}var i,a=(e.config.legalTags,this),o=a.editor,r=a.$txt;r.on("keydown keyup",function(e){if(13===e.keyCode){
// 查找合法标签
...
r=t('<p style="text-indent:2em">'+a.html()+"</p>"),a.after(r),a.remove(),
// 如果是回车结束，将选区定位到行首
...
for(
// 处理图片
a.length&&a.each(function(){t(this).wrap("<p>")}),e=0;e<c;e++)n=r[e],3===n.nodeType&&n.textContent&&t.trim(n.textContent)&&t(n).wrap('<p style="text-indent:2em;">')},
...
r()):
// 未配置上传图片功能
o(),g.click(function(){setTimeout(e)})})}})}),t(function(e,t){e.createMenu(function(n){function i(){var e=s.find("a"),n=u.find(".content");e.each(function(i){t(this).click(function(){e.removeClass("selected"),t(this).addClass("selected"),n.hide(),n.eq(i).show()})})}var a="video";if(n(a)){var o=this,r=o.config.lang,c=/^<(iframe)|(embed)/i,l=new e.Menu({editor:o,id:a,title:r.video}),d=t('<div class="panel-tab"></div>'),s=t('<div class="tab-container"></div>'),u=t('<div class="content-container"></div>');d.append(s).append(u);
// tab
var f=t('<a href="javascript:void(0)" class="selected">上传视频</a>'),m=t('<a href="javascript:void(0)">网络视频</a>');s.append(f).append(m);
// 上传视频 content
var p=t('<div class="content" style="display:block"></div>'),h=t('<div class="upload-icon-container"><i class="wangeditor-menu-img-upload"></i></div>');p.append(h),u.append(p),h.click(function(){o.config.videoUpload&&o.config.videoUpload()});
// 创建 panel 内容
var g=t('<div class="panel-tab"></div>'),v=t('<div style="margin:20px 10px;"></div>'),w=t('<input type="text" class="block" placeholder=\'格式如：<iframe src="..." frameborder=0 allowfullscreen></iframe>\'/>');v.append(w);var x=t('<div style="margin:20px 10px;"></div>'),y=t('<input type="text" value="640" style="width:50px;text-align:center;"/>'),b=t('<input type="text" value="498" style="width:50px;text-align:center;"/>');x.append("<span> "+r.width+" </span>").append(y).append("<span> px &nbsp;&nbsp;&nbsp;</span>").append("<span> "+r.height+" </span>").append(b).append("<span> px </span>");var k=t("<div></div>"),E=t('<a href="http://www.kancloud.cn/wangfupeng/wangeditor2/134973" target="_blank" style="display:inline-block;margin-top:10px;margin-left:10px;color:#999;">如何复制视频链接？</a>'),C=t('<button class="right">'+r.submit+"</button>"),$=t('<button class="right gray">'+r.cancel+"</button>");k.append(E).append(C).append($);
// 网络视频 content
var S=t('<div class="content"></div>');S.append(v).append(x).append(k),u.append(S),i(),g.append(s).append(u),
//$content.append($linkInputContainer).append($sizeContainer).append($btnContainer);
// 取消按钮
$.click(function(e){e.preventDefault(),w.val(""),l.dropPanel.hide()}),
// 确定按钮
C.click(function(e){e.preventDefault();var n,i=t.trim(w.val()),a=parseInt(y.val()),r=parseInt(b.val()),d=t("<div>"),s="<p>{content}</p>";
// 验证数据
// 验证数据
// 设置高度和宽度
// 拼接字符串
// 执行命令
return i?c.test(i)?isNaN(a)||isNaN(r)?void alert("宽度或高度不是数字！"):(n=t(i),n.attr("width",a).attr("height",r),s=s.replace("{content}",d.append(n).html()),o.command(e,"insertHtml",s),void w.val("")):(alert("视频链接格式错误！"),void l.dropPanel.focusFirstInput()):void l.dropPanel.focusFirstInput()}),
// 创建panel
l.dropPanel=new e.DropPanel(o,l,{$content:g,width:400}),
// 增加到editor对象中
o.menus[a]=l}})}),t(function(e,t){e.createMenu(function(n){function i(e){var n=this,i=n.offset(),a=i.left,r=i.top-t("body").scrollTop()+n.height()+20;if(c.css({left:a+"px",top:r+"px"}).show(),e.length){var d="";l.html(""),t.each(e,function(e,n){d=t("<tr><td>"+n.s1+"</td><td>"+n.s3+"</td></tr>"),d.click(function(e){//带有交易所缩写的股票代码(例如sz000002)
var t="<a style='color:red' href='http://data.p5w.net/stock/index.php?code="+n.s2+n.s1+"'>"+n.s3+"</a>";o.command(e,"insertHtml",t),c.hide()}),l.append(d)})}}var a="stock";if(n(a)){var o=this,r=o.config.lang,c=t("<div id='stock-pop' style='position:fixed;z-index:9999; border:1px solid #ccc; padding:5px; background:#fff; left:0; top:0; display:none;'><table width='100%' cellspacing='0' cellpadding='0'><thead><tr><th>代码</th><th>名称</th></tr></thead><tbody></tbody></table></div>"),l=c.find("tbody");c.appendTo("body"),t(document).click(function(){c.hide()}),c.click(function(e){e.stopPropagation()});var d=t("<div></div>"),s=t('<div style="margin:20px 10px;"></div>'),u=t('<input type="text" class="block" placeholder=\'代码 / 简称 / 拼音\'/>');s.append(u),d.append(s);
// 创建 menu 对象
var f=new e.Menu({editor:o,id:a,title:r.stock}),m=0;u.bind("input propertychange",function(e){var n=t(this),a=n.val();clearTimeout(m),m=setTimeout(function(){t.ajax({url:"http://hq.p5w.net/hq/suggestion.php",data:{query:a},type:"get",dataType:"jsonp",success:function(e){i.call(n,e)}})},300)}),
// 创建panel
f.dropPanel=new e.DropPanel(o,f,{$content:d,width:200}),
// 增加到editor对象中
o.menus[a]=f}})}),t(function(e,t){
...
// 按钮
var y=t('<div style="margin:10px 0;"></div>'),b=t('<button class="right">'+l.submit+"</button>"),k=t('<button class="right gray">'+l.cancel+"</button>"),E=t('<label style="display:inline-block;margin-top:10px;color:#666;"></label>'),C=t('<input type="checkbox">');E.append(C).append('<span style="display:inline-block;margin-left:5px;">  '+l.dynamicMap+"</span>"),y.append(E).append(b).append(k),m.append(y),
// 『取消』按钮事件
k.click(function(e){e.preventDefault(),a(),f.dropPanel.hide()}),
// 『确定』按钮事件
b.click(function(e){e.preventDefault();var n,i,o,c=s.map,d=C.is(":checked"),u=s.markers,f=c.getCenter(),m=f.lng,p=f.lat,h=c.getZoom(),g=c.getSize(),v=g.width,w=g.height;if(
//动态地址
...
// 超时处理
function d(){C&&clearTimeout(C),$&&$.abort&&$.abort(),
// 超时了就阻止默认行为
m.preventDefault(),
...
// opt 数据
var m=r.event,p=r.filename||"",h=r.base64,g=r.fileType||"image/png",v=r.name||"wangEditor_upload_file",w=r.loadfn||s,x=r.errorfn||f,y=r.timeoutfn||u,b=o.config.uploadParams||{},k=o.config.uploadHeaders||{},E="png";
// ------------ begin 预览模拟上传 ------------
if(// 默认为 png
p.indexOf(".")>0?
// 原来的文件名有扩展名
E=p.slice(p.lastIndexOf(".")-p.length+1):g.indexOf("/")>0&&g.split("/")[1]&&(
// 文件名没有扩展名，通过类型获取，如从 'image/png' 取 'png'
E=g.split("/")[1]),e.isOnWebsite)return e.log("预览模拟上传"),void i(h,m);
// ------------ end 预览模拟上传 ------------
// 变量声明
var C,$=new XMLHttpRequest,S=new FormData;$.onload=function(){C&&clearTimeout(C),
...
// 隐藏进度条
o.hideUploadProgress()},$.onerror=function(){C&&clearTimeout(C),
// 超时了就阻止默认行为
m.preventDefault(),
...
// 修改自定义配置的headers
t.each(k,function(e,t){$.setRequestHeader(e,t)}),
// 跨域上传时，传cookie
$.withCredentials=!0,
// 发送数据
$.send(S),C=setTimeout(d,l),e.log("开始上传...并开始超时计算")})})}),t(function(e,t){e.plugin(function(){function e(){d||(d=!0,l.css({top:o+"px"}),r.append(l))}function n(){l.hide(),s=null}var i=this,a=i.menuContainer,o=a.height(),r=i.$editorContainer,c=r.width(),l=t('<div class="wangEditor-upload-progress"></div>'),d=!1;
// ------ 显示进度 ------
...
// 清空 input 数据
function n(){i.clear()}var i=this,a=i.editor,o=t.name||"",r=t.type||"",c=a.config.uploadImgFns,l=a.config.uploadImgFileName||"wangEditorH5File",d=c.prvonload,s=c.onload,u=c.ontimeout,f=c.onerror,m=new FileReader;
// onload事件
// 开始取文件
return s&&u&&f?(e.log("开始执行 "+o+" 文件的上传"),m.onload=function(t){e.log("已读取"+o+"文件");var i=t.target.result||this.result;d.call(a,i,o),a.xhrUploadImg({event:t,filename:o,base64:i,fileType:r,name:l,loadfn:function(e,t){n();
// 执行配置中的方法
var i=this;s.call(i,e,t)},errorfn:function(t){n(),e.isOnWebsite&&alert("wangEditor官网暂时没有服务端，因此报错。实际项目中不会发生");
// 执行配置中的方法
var i=this;f.call(i,t)},timeoutfn:function(t){n(),e.isOnWebsite&&alert("wangEditor官网暂时没有服务端，因此超时。实际项目中不会发生");
// 执行配置中的方法
var i=this;u(i,t)}})},void m.readAsDataURL(t)):void e.error("请为编辑器配置上传图片的 onload ontimeout onerror 回调事件")},
// 暴露给 E
...
a(),o(),
// 菜单放入 container
b.append(k).append(E).append(C).append($).append(S).append(M).append(T).append(N),
// 链接input放入container
...
// 放大
C.click(function(t){i=function(){var e=d.get(0),t=e.width,n=e.height;t*=1.1,n*=1.1,d.css({width:t+"px",height:n+"px"})},e(t,function(){setTimeout(r)})}),
// 缩小
E.click(function(t){i=function(){var e=d.get(0),t=e.width,n=e.height;t*=.9,n*=.9,d.css({width:t+"px",height:n+"px"})},e(t,function(){setTimeout(r)})}),
// // 左浮动
...
s.enableMenusExcept())}
// 判断img是否是一个表情
function l(e){var n=!1;return s.emotionUrls?(t.each(s.emotionUrls,function(t,i){var a=!1;if(e===i&&(n=!0,a=!0),a)return!1}),n):n}var d,s=this,u=s.config.lang,f=s.txt,m=f.$txt,p="",h=s.useMaxHeight?m.parent():m,g=(s.$editorContainer,""),v=!1,w=t('<div class="img-drag-point"></div>'),x=t('<div class="txt-toolbar"></div>'),y=t('<div class="tip-triangle"></div>'),b=t("<div></div>"),k=t('<a href="#"><i class="wangeditor-menu-img-trash-o"></i></a>'),E=t('<a href="#"><i class="wangeditor-menu-img-search-minus"></i></a>'),C=t('<a href="#"><i class="wangeditor-menu-img-search-plus"></i></a>'),$=t('<a href="#"><i class="wangeditor-menu-img-align-left"></i></a>'),S=t('<a href="#"><i class="wangeditor-menu-img-align-center"></i></a>'),M=t('<a href="#"><i class="wangeditor-menu-img-align-right"></i></a>'),T=t('<a href="#"><i class="wangeditor-menu-img-link"></i></a>'),N=t('<a href="#"><i class="wangeditor-menu-img-unlink"></i></a>'),R=t('<div style="display:none;"></div>'),D=t('<input type="text" style="height:26px; margin-left:10px; width:200px;"/>'),P=t('<button class="right">'+u.submit+"</button>"),O=t('<button class="right gray">'+u.cancel+"</button>"),I=!1;
// click img 事件
