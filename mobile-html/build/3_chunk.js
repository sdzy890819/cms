...
exports.default = {
	...
	mounted: function mounted() {
		var self = this;
		_global2.default.ajax({ //获取部门分类
			url: _URL.category.listCategory,
			success: function success(_data) {
				self.data.listCategory = _data.data;
				_global2.default.ajax({ //获取上一次操作时的 记录
					url: _URL.news.previousColumn,
					success: function success(_data) {
						try {
	...
	methods: {
		...
		categoryEvent: function categoryEvent(callback) {
			var self = this;
		...
		listChannelEvent: function listChannelEvent(callback) {
			var self = this;
			if (self.channelId < 0) {
				__webpack_require__.e/* require.ensure */(0/* duplicate */).then((function (require) {
					var Pop = __webpack_require__(41);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("请选择部门分类")]), _vm._v(" "), _vm._l((_vm.data.listCategory), function(option) {
    return _c('option', {
      domProps: {
        "value": option.id
      }
...
var update = __webpack_require__(5)("5c73dc16", content, false);
...
//# sourceMappingURL=3_chunk.js.map?name=cc6b1ad91dffd17061f0