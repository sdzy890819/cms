    ...
    load: function load() {
        ...
        if (timing == 'lightLoader') {
            ...
            __webpack_require__.e/* require.ensure */(10).then((function () {
                var lightLoader = __webpack_require__(40);
            ...
            __webpack_require__.e/* require.ensure */(9).then((function () {
                var Sonic = __webpack_require__(41);
                var option = {},
                    width = 50,
                    height = 50,
                    half = width / 2;
	...
	routes: [{ path: '/', redirect: '/new' }, { path: '/new', component: _box2.default,
		children: [{ path: '', redirect: 'list' }, { // new or new/list
			...
			component: function component(resolve) {
				__webpack_require__.e/* require */(8).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(29)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
			},
			alias: ['/new']
		}, {
			path: 'add',
		...
		children: [{ path: '', redirect: 'list' }, { // new or new/list
			...
			path: 'add',
			component: function component(resolve) {
				__webpack_require__.e/* require */(7).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(24)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
			}
		}, {
			path: 'edit',
			component: function component(resolve) {
		...
		children: [{ path: '', redirect: 'list' }, { // new or new/list
			path: 'list',
			component: function component(resolve) {
				__webpack_require__.e/* require */(1).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(32)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
			},
			alias: ['/video']
		}, {
			path: 'add',
			component: function component(resolve) {
				__webpack_require__.e/* require */(3).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(30)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
			}
		}, {
			path: 'edit',
			component: function component(resolve) {
				__webpack_require__.e/* require */(2).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(31)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
			}
		}]
	}, {
		path: '/login',
...
//# sourceMappingURL=mobile.js.map?name=ba94c7bc7dd7246bfa0a