...
public class ChannelController extends BaseController {
    ...
    public String createChannel(HttpServletRequest request,
        ...
        channel.setChannelPath(FileUtil.addSuffix(channelPath));
        channel.setTemplatePath(FileUtil.addSuffix(templatePath));
        channel.setChannelUrl(FileUtil.addSuffix(channelUrl));
